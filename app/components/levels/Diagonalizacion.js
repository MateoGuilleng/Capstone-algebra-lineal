...
export default function Diagonalizacion({ step, onStepComplete, onLevelComplete, onTotalStepsChange, level }) {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "Encuentra un vector propio asociado a un valor propio dado. ",
    ...
    },
    {
      ...
      description: "Comprende cómo se forma la matriz P de vectores propios.",
      ...
      solution: 'CONCEPTUAL_LEVEL: P = [[1,0],[1,1]]',
    ...
    },
    {
      ...
      description: "Comprende el papel de la inversa de la matriz P en la diagonalización.",
      ...
      solution: 'CONCEPTUAL_LEVEL: P^-1 = [[1,0],[-1,1]]',
    ...
    },
    {
      ...
      description: "Comprende la estructura de la matriz diagonal D. ",
    ...
    },
    {
      ...
      description: "Determina si la matriz dada es diagonalizable.",
